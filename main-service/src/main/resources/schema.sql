drop table IF EXISTS ratings, comp_events, compilations, part_requests, events, categories, locations, users CASCADE;
...
CREATE TABLE IF NOT EXISTS part_requests (
    ...
    id                  BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    created             TIMESTAMP,
    event               BIGINT NOT NULL, -- fk
    requester           BIGINT NOT NULL, -- fk
    status              VARCHAR(255),

    CONSTRAINT  pk_part_req PRIMARY KEY (id),

    CONSTRAINT  fk_part_req_event
        FOREIGN KEY (event)
            REFERENCES events (id)
            ON DELETE CASCADE,

    CONSTRAINT  fk_part_req_requester
